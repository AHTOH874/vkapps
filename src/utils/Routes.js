...
import {
  getProp,
  isControlledProp
} from '@react-yandex-maps/util/props';
import {withYMaps} from 'react-yandex-maps';
import * as events from '@react-yandex-maps/util/events';
import applyRef from '@react-yandex-maps/util/ref';
import {
  withParentContext
...
export default withYMaps(Route, true, ['route']);